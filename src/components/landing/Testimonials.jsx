...
const testimonials = [
  {
    name: 'Marcus T.',
    role: 'Ledger Nano X User',
    initials: 'MT',
    stars: 5,
    quote: 'I thought my digital currency was gone forever after my Ledger malfunctioned. The recovery team had my wallet access restored in under 48 hours. Absolutely professional and transparent throughout the entire process.',
    accentColor: 'bg-cyber-purple/20 text-cyber-purple border-cyber-purple/30',
    glow: 'purple',
  },
  {
    name: 'Sarah L.',
    role: 'MetaMask Recovery',
    initials: 'SL',
    stars: 5,
    quote: 'After a phishing attack compromised my MetaMask wallet, I was desperate. Their forensic team helped me secure my remaining assets and guided me through the entire recovery process. Could not recommend them more highly.',
    accentColor: 'bg-cyber-green/20 text-cyber-green border-cyber-green/30',
    glow: 'green',
  },
  {
    name: 'David K.',
    role: 'Trust Wallet User',
    initials: 'DK',
    stars: 5,
    quote: 'Lost access to my Trust Wallet with a significant amount in staked tokens. The team recovered everything and even helped me improve my security setup. Their 24/7 support made all the difference during a stressful time.',
