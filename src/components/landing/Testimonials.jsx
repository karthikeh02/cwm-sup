...
const testimonials = [
  {
    ...
    initials: 'MT',
    stars: 5,
    quote: 'I thought my crypto was gone forever after my Ledger malfunctioned. The recovery team had my wallet access restored in under 48 hours. Absolutely professional and transparent throughout the entire process.',
